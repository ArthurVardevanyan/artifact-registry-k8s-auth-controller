...
import (
	...
	"github.com/ArthurVardevanyan/artifact-registry-k8s-auth-controller/controllers"
...
func init() {
	...
	utilruntime.Must(artifactregistryv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a4557a1f.arthurvardevanyan.com",
